    ...
    <el-card>
      <el-form label-width="180px" ref="form">
        ...
        <el-form-item label="图片">
          <div v-for="(item,index) in form.imgs" :key="index" class="avatar-uploader" action="/api/upload" :show-file-list="false" :on-success="(res, file)=>handleAvatarSuccess(res, file,index)" :before-upload="beforeAvatarUpload">
