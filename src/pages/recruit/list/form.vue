    ...
    <el-card>
      ...
      >
        ...
        <el-form-item label="图片">
          ...
          >
            <div class="el-upload el-upload--text" style="cursor: default;">
              <form-img :img="item"></form-img>
              <i
                class="imgs-del el-icon el-icon-delete"
                @click.stop="img_del_handle(index)"
              ></i>
            </div>
          </div>
          <el-upload
        ...
        <el-form-item label="类型">
          <el-col
            :span="4"
            style="min-width:190px;padding-right: 10px;"
          >
            <el-select
              size="small"
              v-model="form.type"
          ...
          >
            <el-input-number
              size="small"
              v-model="form.laborPrice"
              :min="1"
              :max="999"
            ></el-input-number><span style="margin-left:8px;">元/小时</span>
          </el-col>
        </el-form-item>
        <el-form-item label="补贴">
          ...
          >
            <div>
              <vue-editor
                :edit="form.subsidys[index].value"
                @changeedit="content=>form.subsidys[index].value = content"
              ></vue-editor>
            </div>
            <div
              class="subsidy-close"
              @click="subsidy_close(index)"
            ><i class="el-dialog__close el-icon el-icon-close"></i></div>
          </div>
          <el-button
            type="success"
            size="small"
        ...
        <el-form-item label="工资福利">
          <vue-editor
            :edit="form.wages"
            @changeedit="content=>form.wages = content"
          ></vue-editor>
        </el-form-item>
        <el-form-item label="岗位介绍">
          <vue-editor
            :edit="form.post"
            @changeedit="content=>form.post = content"
          ></vue-editor>
        </el-form-item>
        <el-form-item label="企业介绍">
          <vue-editor
            :edit="form.introduce"
            @changeedit="content=>form.introduce = content"
          ></vue-editor>
        </el-form-item>
      </el-form>
    </el-card>
